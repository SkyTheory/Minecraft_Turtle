...
function setFunctions()
  ...
  compareFn.FORWARD = turtle.compare
  compareFn.UP = turtle.compareUp
  compareFn.DOWN = turtle.compareDown
end

function rotate(key)
  if (key == "FORWARD" or key == "UP" or key == "DOWN") then
    return key
  else
    turn(key)
    return "FORWARD"
