...
advance1:addRule(Rules.MapState.getState("obstruction", "DOWN"), false)
advance1:addTask(Tasks.TurtleTasks.move("DOWN"))
...
advance3:addRule(Rules.MapState.getState("obstruction", "DOWN"))
...
retreat1:addTask(Tasks.TurtleTasks.move("UP"))
